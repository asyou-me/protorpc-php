...
func (client *Client) Go(serviceMethod string, args []byte, reply *[]byte, done chan *Call) *Call {
	call := new(Call)
...
func (client *Client) Call(serviceMethod string, args []byte, reply *[]byte) error {
